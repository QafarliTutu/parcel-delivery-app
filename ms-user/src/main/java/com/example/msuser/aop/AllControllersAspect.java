package com.example.msuser.aop;
...
public class AllControllersAspect {
    ...
    @Before(value = "execution(* com.example.msuser.controller.v1.*.*(..))")
    ...
    @AfterReturning(value = "execution(* com.example.msuser.controller.v1.*.*(..))", returning = "result")
