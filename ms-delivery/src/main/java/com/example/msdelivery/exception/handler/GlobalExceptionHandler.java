package com.example.msdelivery.exception.handler;
...
import com.example.msdelivery.util.response.ErrorDetail;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleInternal(Exception ex, WebRequest request) {
        ...
        return handleExceptionInternal(
                ex, ServiceResponse.error(ResponseCode.SYSTEM_ERROR, ex.getMessage()),
                new HttpHeaders(),
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        return handleExceptionInternal(
                ex,
                ServiceResponse.error(ResponseCode.VALIDATION_FAILED, errorDetails),
                new HttpHeaders(),
    ...
    protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex,
        ...
        return handleExceptionInternal(
                ex,
                ServiceResponse.error(ResponseCode.VALIDATION_FAILED, ex.getMessage()),
                new HttpHeaders(),
    ...
    protected ResponseEntity<Object> handleServletRequestBindingException(ServletRequestBindingException ex,
        ...
        return handleExceptionInternal(
                ex,
                ServiceResponse.error(ResponseCode.VALIDATION_FAILED, message),
                new HttpHeaders(),
                HttpStatus.BAD_REQUEST,
                request);
    }
